local kind = require("jduque.kind")
...
local header = {
  type = "text",
  val = require("jduque.banners").dashboard(),
  opts = {
    position = "center",
    hl = "Comment",
  },
...
local buttons = {
  ...
  val = {
    ...
    button("C", " " .. kind.cmp_kind.Color .. " Colorscheme Config", ":e ~/.config/lvim/lua/jduque/colorizer.lua<CR>"),
