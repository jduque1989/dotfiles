...
lvim.builtin.which_key.mappings["a"] = {
  ...
  t = { "<cmd>lua require('avante').toggle()<CR>", "Toggle" },
  s = { "<cmd>lua require('avante').toggle_suggestion()<CR>", "Toggle Suggestion" },
  f = { "<cmd>lua require('avante').focus()<CR>", "Focus" },
  r = { "<cmd>lua require('avante').refresh()<CR>", "Refresh" },
  e = { "<cmd>lua require('avante').edit()<CR>", "Edit" },
  a = { "<cmd>lua require('avante').ask()<CR>", "Ask" },
}
...
-- if status_ok then
--   which_key.register(lvim.builtin.which_key.mappings)
-- end
-- print(vim.inspect(lvim.builtin.which_key.mappings["g"]))
